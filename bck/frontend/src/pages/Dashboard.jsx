...
function generarHTMLInforme(item) {
  ...
  const avisoHtml = tieneUrlAviso(item)
    ? `<a class="btn" href="${escaparHTML(item.urlDetalle)}" target="_blank" rel="noopener noreferrer">Ver aviso REMAJU ↗</a>`
    : `<span class="muted">Ver aviso REMAJU ↗ no disponible para este inmueble.</span>`;
                      ...
                      <td>
                        <div className="acciones-tabla">
                          ...
                          {tieneUrlAviso(item) ? (
                            ...
                            <span className="aviso-no-registrado">
                              Sin aviso REMAJU
                            </span>
                          )}
          ...
          <section className="panel analisis-panel" id="oportunidades">
            <div className="analisis-header">
              ...
              <div className="acciones-informe">
                ...
                {tieneUrlAviso(mejorInmueble) && (
                  <a
                    className="btn-terciario"
                    href={mejorInmueble.urlDetalle}
                    target="_blank"
                    rel="noopener noreferrer"
                  >
                    Ver aviso REMAJU ↗
                  ...
                  >
                    <Popup>
                      ...
                      {tieneUrlAviso(item) && (
                        <>
                          <br />
                          <a href={item.urlDetalle} target="_blank" rel="noopener noreferrer">
                            Ver aviso REMAJU ↗
                          </a>
                        </>
                      )}
